...
export async function GET(req: Request) {
  ...
  try {
    ...
    const nfts = data.map((x) => ({
      ...
      animationUrl: x.mint?.animationUrl ?? null,
      description: x.mint?.description ?? null,
      collection: x.mint?.collection ?? null,
      brand: x.mint?.brand ?? null,
      project: x.mint?.project ?? null,
      item: x.mint?.item ?? null,
      rarity: x.mint?.rarity ?? null,
      category: x.mint?.category ?? null,
      mediaKind: x.mint?.mediaKind ?? null,
      metadataSyncedAt: x.mint?.metadataSyncedAt ?? null,
      metadataError: x.mint?.metadataError ?? null,
    }));
