...
// ─── Design tokens ────────────────────────────────────────────────────────────
// Radius:  rounded-2xl (buttons/pills) · rounded-[28px] (cards) · rounded-[36px] (section cards)
...
// Animations: .animate-orb-1 / .animate-orb-2 / .animate-top-glow live in globals.css
...
const STORY_CARDS = [
  { label: "Creator Story",          title: "Real work becomes digital value",       text: "A real painting, created by hand, can become a collectible digital asset inside the Realife ecosystem.",                                           image: "/brand/1.jpg", alt: "Creator standing with finished painting" },
  { label: "Creative Process",       title: "Proof begins with the making",          text: "Realife starts from authentic human effort — the process, the skill, and the story behind the finished work.",                                     image: "/brand/2.jpg", alt: "Painting process close-up" },
  { label: "Collectible Presentation", title: "From artwork to premium asset",       text: "A finished piece can be presented, packaged, and prepared as a collectible object with digital ownership value.",                                  image: "/brand/3.jpg", alt: "Artwork with certificate and premium presentation" },
  { label: "Brand Collaboration",    title: "Creative work can power campaigns",     text: "Artists, makers, and brands can turn real creations into collectible stories, product concepts, and community activations.",                        image: "/brand/4.jpg", alt: "Creative collaboration session" },
  { label: "Creator Shipping",       title: "Creators can send real value",          text: "A work made at home can move beyond the studio — carefully prepared for delivery into the wider Realife economy.",                                 image: "/brand/5.jpg", alt: "Creator sending a painting" },
  { label: "Collector Delivery",     title: "Ownership arrives in the real world",   text: "Realife connects digital ownership with physical delivery, so value can be experienced both on-chain and offline.",                                image: "/brand/6.jpg", alt: "Buyer receiving delivered artwork" },
  { label: "Accessible Web3",        title: "Built for everyday creators",           text: "Realife is designed for ordinary talented people — not only traders or developers, but anyone with real creative skill.",                          image: "/brand/7.jpg", alt: "Everyday creator with artwork in studio" },
] as const;
...
function Pill({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={cx(
      ...
      "px-3 py-1.5 text-[11px] font-semibold text-white/60 backdrop-blur-2xl",
...
function GhostButton({ href, children, className = "" }: { href: string; children: React.ReactNode; className?: string }) {
  return (
    <Link
      href={href}
      className={cx(
        "inline-flex items-center justify-center rounded-2xl border border-white/15 bg-white/[0.06] px-7 py-4 font-semibold backdrop-blur-2xl",
...
function SectionHeading({ label, title, text, center = false }: {
  label: string; title: string; text?: string; center?: boolean;
}) {
  return (
    <div className={cx(center && "mx-auto text-center")}>
      ...
      {text && <p className="mt-4 max-w-3xl text-base text-white/60">{text}</p>}
    </div>
  );
}

function StoryCard({ item, className = "", imageClassName = "" }: {
  item: (typeof STORY_CARDS)[number]; className?: string; imageClassName?: string;
}) {
  return (
...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#070606] text-white">
      ...
      {/* ── Ambient background — animations from globals.css ─────── */}
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to right,rgba(212,175,55,0.22) 1px,transparent 1px),linear-gradient(to bottom,rgba(212,175,55,0.18) 1px,transparent 1px)",
      ...
      <div className="relative z-30 mx-auto max-w-7xl px-6 py-8 md:py-10">
            ...
            <div className="lg:col-span-6">
              ...
              <div className="mt-10 grid gap-4 md:grid-cols-12">
                <GlassCard className="md:col-span-5">
                  <div className="p-5">
                    <div className="text-[11px] font-semibold text-white/40">Wallet</div>
                    <div className="mt-3">
                      <ConnectWallet />
                    </div>
                ...
                <GlassCard className="md:col-span-7">
                  <div className="p-5">
                    <div className="text-[11px] font-semibold text-white/40">Crypto-native proof</div>
                    <div className="mt-4 grid gap-3 sm:grid-cols-3">
                      {HERO_PROOFS.map((x) => (
                        <div key={x.t} className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(0,0,0,0.30),rgba(0,0,0,0.22))] p-4 shadow-[0_18px_70px_rgba(0,0,0,0.25)]">
                          <div className="text-sm font-bold tracking-tight">{x.t}</div>
              ...
              <GlassCard className="rounded-[36px] before:rounded-[36px]">
                <div className="p-6 md:p-8">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <div className="text-sm text-white/40">Main video</div>
                      <div className="text-2xl font-black tracking-tight">Realife in motion</div>
                    </div>
                    <div className="rounded-full border border-white/10 bg-black/35 px-3 py-1.5 text-[11px] text-white/60">Hero</div>
                  </div>
                  ...
                  <div className="mt-5 grid gap-3 sm:grid-cols-2">
                    {[
                      ["Creators",       "Real work becomes NFTs, proof, reputation, and market-ready assets."],
                      ["Crypto brands",  "Campaigns, branded products, collectible stories, and community activations."],
                      ["Collectors",     "Own, trade, and receive tokenized real-world value inside a premium UX."],
                      ["Phygital utility", "Digital ownership can stay on-chain or move into physical delivery and goods."],
                    ].map(([t, d]) => (
            ...
            <GlassCard className="rounded-[36px] before:rounded-[36px]">
              <div className="p-6 md:p-10">
                ...
                <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  {CORE_FLOW.map((x) => (
                    <div key={x.n} className="rounded-[28px] border border-white/10 bg-white/[0.04] p-5 shadow-[0_22px_80px_rgba(0,0,0,0.35)] transition hover:bg-white/[0.06]">
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-3">
              <GlassCard className="h-full">
                <div className="flex h-full flex-col p-8">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-white/60">
                    The ecosystem hub for creator campaigns, crypto brand collaborations, Crypto Cafe, and Realife Store.
                  </p>
                  <div className="mt-6 grid gap-3">
                    {[
                      ...
                      <div key={x} className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-white/75">{x}</div>
                    ))}
                  </div>
                  <div className="mt-auto pt-8">
                    <GoldButton href={REAL_MARKETING_HREF} className="w-full">Enter Real Marketing</GoldButton>
                  </div>
                </div>
              </GlassCard>
              ...
              <GlassCard className="overflow-hidden">
                <div className="relative aspect-[4/5] w-full">
                  ...
                  <div className="absolute left-4 top-4"><Pill className="bg-black/40">Crypto Cafe</Pill></div>
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="text-2xl font-black tracking-tight">Realife Crypto Cafe</div>
                    <div className="mt-2 text-sm leading-relaxed text-white/60">A premium storefront concept for branded goods, collectible atmosphere, and phygital experiences.</div>
                  </div>
                </div>
              </GlassCard>
              ...
              <GlassCard className="overflow-hidden">
                <div className="relative aspect-[4/5] w-full">
                  ...
                  <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(0,0,0,0.62),rgba(0,0,0,0.08))]" />
                  <div className="absolute left-4 top-4"><Pill className="bg-black/40">Realife Store</Pill></div>
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="text-2xl font-black tracking-tight">Realife Store</div>
                    <div className="mt-2 text-sm leading-relaxed text-white/60">Tokenized real-world products, branded packaging, and collectible ownership stories.</div>
                  </div>
                </div>
              </GlassCard>
            </div>
            ...
            <GlassCard className="rounded-[36px] before:rounded-[36px]">
              <div className="grid items-center gap-8 p-6 md:p-10 lg:grid-cols-12">
                ...
                <div className="lg:col-span-7">
                  <div className="rounded-[28px] p-px bg-[linear-gradient(135deg,rgba(247,231,167,0.35),rgba(212,175,55,0.16),rgba(184,135,10,0.12))]">
                    <div className="rounded-[28px] border border-white/10 bg-[#0b0a09]/75 p-4 backdrop-blur-2xl">
                      <div className="mb-4 flex flex-wrap items-center gap-2">
                        {["Create NFT", "Marketplace", "Delivery"].map((tab, i) => (
                          <div key={tab} className={cx(
                      ...
                      <div className="overflow-hidden rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01))]">
                        <div className="grid gap-4 p-5 md:grid-cols-12">
                          <div className="md:col-span-7">
                            <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
                              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/40">Create asset</div>
                              <div className="mt-3 space-y-3">
                                {[
                                  ...
                                  <div key={k} className="rounded-xl border border-white/[0.08] bg-white/[0.03] px-3 py-2">
                                    <div className="text-[10px] font-semibold uppercase text-white/40">{k}</div>
                          ...
                          <div className="md:col-span-5">
                            <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
                              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/40">Status</div>
                              <div className="mt-3 flex flex-wrap gap-2">
                                {["Wallet connected", "IPFS metadata", "Base Sepolia", "Mint verified"].map((x) => (
                                  <div key={x} className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[11px] font-semibold text-white/75">{x}</div>
                                ))}
                              </div>
                              <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                                <div className="text-sm font-bold tracking-tight">Creator-ready interface</div>
                                <div className="mt-2 text-xs leading-relaxed text-white/60">Clean enough for normal people, structured enough for Web3 logic, and premium enough for investor demos.</div>
                              </div>
                              <div className="mt-3 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                                <div className="text-sm font-bold tracking-tight">Real-world utility layer</div>
                                <div className="mt-2 text-xs leading-relaxed text-white/60">The asset can remain collectible, move into trading, or connect to physical delivery.</div>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <Reveal className="mt-24">
          <section>
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-12">
              <div className="lg:col-span-7"><StoryCard item={STORY_CARDS[0]} imageClassName="aspect-[16/12]" /></div>
              <div className="lg:col-span-5"><StoryCard item={STORY_CARDS[1]} imageClassName="aspect-[4/5]" /></div>
              <div className="lg:col-span-5"><StoryCard item={STORY_CARDS[2]} imageClassName="aspect-[4/5]" /></div>
              <div className="lg:col-span-7"><StoryCard item={STORY_CARDS[3]} imageClassName="aspect-[16/12]" /></div>
              <div className="lg:col-span-6"><StoryCard item={STORY_CARDS[4]} imageClassName="aspect-[16/12]" /></div>
              <div className="lg:col-span-6"><StoryCard item={STORY_CARDS[5]} imageClassName="aspect-[16/12]" /></div>
            </div>
              ...
              <GlassCard className="overflow-hidden">
                <div className="grid items-center gap-0 md:grid-cols-12">
                  <div className="relative min-h-[420px] bg-[#120f0d] md:col-span-5">
                    <Image src={STORY_CARDS[6].image} alt={STORY_CARDS[6].alt} fill className="object-contain object-center p-4" sizes="(max-width: 768px) 100vw, 40vw" />
                  ...
                  <div className="p-8 md:col-span-7 md:p-10">
                    ...
                    <h3 className="mt-5 text-3xl font-black tracking-tight md:text-4xl">{STORY_CARDS[6].title}</h3>
                    <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/60 md:text-base">{STORY_CARDS[6].text}</p>
              ...
              <div className="grid items-center gap-8 p-8 md:p-12 lg:grid-cols-12">
                ...
                <div className="lg:col-span-4">
                  <div className="flex flex-col gap-3">
                    <GoldButton href="/app/create" className="w-full">Start minting</GoldButton>
                    <GhostButton href={REAL_MARKETING_HREF} className="w-full">Explore Real Marketing</GhostButton>
                    <GhostButton href="/app/trading" className="w-full">Open trading</GhostButton>
                  </div>
                </div>
              </div>
            </GlassCard>
        ...
        <footer className="mt-16 flex flex-wrap items-center justify-between gap-4 pb-10 text-xs text-white/40">
          ...
          <div className="flex flex-wrap items-center gap-4 opacity-60">
            ...
            <span>Tokenized real-world assets</span>
          </div>
        </footer>
