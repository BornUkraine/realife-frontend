    ...
    >
      <div
        className={[
          ...
          "before:bg-[radial-gradient(circle_at_18%_0%,rgba(14,165,233,0.12),transparent_45%)]",
...
export default async function RealifeStoreTradingPage() {
