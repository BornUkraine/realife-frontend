    ...
    <div className="space-y-4">
      <Reveal>
        <GoldEdgeWrap className="rounded-[22px]">
          <div className="relative overflow-hidden p-4 md:p-5">
            <div className="pointer-events-none absolute -top-32 -right-32 h-[320px] w-[320px] rounded-full bg-amber-500/10 blur-3xl" />
            ...
            <div className="relative">
              <div className="flex flex-wrap items-center gap-2">
                <Pill>
                  <span className="h-1.5 w-1.5 rounded-full bg-amber-400 shadow-[0_0_0_4px_rgba(245,158,11,0.12)]" />
                  Goods Protected
                </Pill>

                <Pill>
                  <span className="text-white/80 font-extrabold">
                    Protected quantity mint
                  </span>
                </Pill>
              ...
              <p className="mt-2 max-w-3xl text-xs leading-relaxed text-white/65 md:text-sm">
                Physical goods NFTs minted through the protected quantity ERC-1155 contract and listed through the PROTECTED USDC escrow flow. Focused on goods, delivery, fulfillment, shipping coordination and buyer confirmation.
              </p>
      ...
      <Reveal delayMs={100}>
        <TradingClient
          ...
          initialMarketView="publicDelivery"
          lockMarketView={true}
        />
      </Reveal>
    </div>
