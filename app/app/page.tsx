...
type Nav = { label: string; href: string; enabled: boolean; tag?: string };
...
export default function AppPage() {
  ...
  const nav = useMemo<Nav[]>(
    () => [
      ...
      { label: "Trading NFTs", href: "/app/trading", enabled: false, tag: "Soon" },
      { label: "Real Marketing", href: "/app/marketing", enabled: false, tag: "Soon" },
      { label: "Social Learning", href: "/app/learning", enabled: false, tag: "Soon" },
      { label: "Profile", href: "/app/profile", enabled: false, tag: "Soon" },
  ...
  return (
    <main className="min-h-screen text-white">
      ...
      <div className="pointer-events-none fixed inset-0">
        {/* deep vignette + gold spotlight */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(212,175,55,0.11),transparent_55%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_115%,rgba(255,255,255,0.05),transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_20%,rgba(212,175,55,0.10),transparent_55%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_90%_10%,rgba(212,175,55,0.08),transparent_60%)]" />
        ...
        <div className="absolute inset-x-0 top-0 h-56 bg-[linear-gradient(to_bottom,rgba(0,0,0,0.65),transparent)]" />
      </div>

      <div className="relative mx-auto w-full max-w-7xl px-6 md:px-10 py-10 md:py-14 grid grid-cols-12 gap-8 lg:gap-10">
        {/* SIDEBAR */}
        <aside className="col-span-12 lg:col-span-3">
          <div className="sticky top-24">
            <GoldEdgeCard className="rounded-[34px]">
              <div className="p-6">
                {/* Brand */}
                <Link href="/app" className="flex items-center gap-4 mb-8">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-white/60 truncate">premium creator app</p>
                  </div>
                </Link>
