...
// Можно переопределить в .env.local, например:
...
export default function SuccessPage() {
  ...
  // resolved data (can be enhanced from backend)
  ...
  // If preview is blocked/missing, try fetching metadata via backend using tokenId
  useEffect(() => {
    let alive = true;
  ...
  return (
    <AppShell title="REALIFE" subtitle="Success • On-chain proof">
